...
<section class="main-cover main-row">
	<section id="main">
		...
		<section id="contents">
			<header class="panel">
				 ■ Home > Notice Management > Notice List
			</header>
					...
					<form method="post" name="listForm" id="listForm" onsubmit="return searchList(this,1); return false;">
						<div class="contents-top">
							<div class="top-tools">
								...
								<div class="btn-tools"><button class="btn-blue" onclick="document.location.href='/admin/notice/notice_edit.go?noticeSeq=0';">New</button></div>
								<div class="btn-tools"><button class="btn-blue-green" onclick="windowOpen('/m/notice/notice.go','FaceTalk',320,480,'yes','no');">Mobile View</button></div>
							</div>
						</div>
